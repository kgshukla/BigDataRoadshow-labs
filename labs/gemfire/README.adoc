...
=== Setting up the terminal sessiontr
All instructions assume that the terminal session is started in the labs directory of the roadshow project. +
Within the terminal (as gpadmin user) execute the following steps: +
[source]
----
[pivhdsne:Desktop]$ cd /home/gpadmin/Desktop/BigDataRoadshow-labs/labs
----
...
image::images/gemfire-rest-api-response.png[]
